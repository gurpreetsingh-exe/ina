...
let unify_roots ut key0 key1 new_value =
  ...
  if rank0 > rank1 then redirect_root ut rank0 key1 key0 new_value
  else if rank0 < rank1 then redirect_root ut rank1 key0 key1 new_value
